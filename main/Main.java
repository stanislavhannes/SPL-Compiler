...
class Main {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      SemanticChecker semant = new SemanticChecker();
      Table globalTable = semant.check(program, optionTables);
      VarAllocator varalloc = new VarAllocator(globalTable, optionVars);
      varalloc.allocVars(program);
      try {
        FileWriter outFile = new FileWriter(outFileName);
        Codegenerator codegen = new Codegenerator(outFile);
        codegen.genCode(program, globalTable);
        outFile.close();
